...
A purecore nasceu da vontade de implementar ferramentas que uso de forma nativa e sem dependências externas. Por exemplo, a lib criada para que eu possa trocar do Express para a @purecore/apify, foi implementada a mesma interface para que só seja necessário a mudança do `import`. E para validar utilizei a lib helmet e funcionou de primeira. 
